...
## Project Structure
    ...
    ├── hammad_crowdbotics_31507  # Django project configurations
...
1. Clone this repo and `cd hammad_crowdbotics_31507`
...
2. Clone this repo and `cd hammad_crowdbotics_31507`
